...
(function ($) {
	...
	function renderElements() {
		$.each(settings.markers, function (index, markerObject) {
			...
			var labelText = "";
			if (latitude == "-27.416207" && longitude == "-49.600771") {
				labelText = "A localização no mapa ainda não está disponível para este imóvel.<br />Entre em contato conosco para mais informações.";
